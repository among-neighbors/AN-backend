...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        ).excludePathPatterns("/api/v1/communities/new", "/api/v1/notices/new", "/api/v1/comments/**/new", "/api/v1/communities/me");

        registry.addInterceptor(profileTokenInterceptor).addPathPatterns(
                "/api/v1/profiles/**", "/api/v1/communities/new", "/api/v1/notices/new", "/api/v1/comments/**/new", "/api/v1/communities/me"
        );
    }
}
